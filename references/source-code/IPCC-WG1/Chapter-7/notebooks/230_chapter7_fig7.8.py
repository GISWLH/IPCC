...
# Source: Chapter-7/notebooks/230_chapter7_fig7.8.ipynb
...
for forcing in forcings:
    ...
    AR6_forc[forcing] = np.percentile(        
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_%s_climuncert' % forcing]['surface_temperature'] - results['remove_%s_climuncert' % forcing]['surface_temperature'][0]),
...
other_anth = (
    (
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_h2o_stratospheric_climuncert']['surface_temperature'] - results['remove_h2o_stratospheric_climuncert']['surface_temperature'][0])
    ) +
    (
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_contrails_climuncert']['surface_temperature'] - results['remove_contrails_climuncert']['surface_temperature'][0])
    ) +
    (
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_land_use_climuncert']['surface_temperature'] - results['remove_land_use_climuncert']['surface_temperature'][0])
    ) +
    (
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_bc_on_snow_climuncert']['surface_temperature'] - results['remove_bc_on_snow_climuncert']['surface_temperature'][0])
    )
)
...
other_anth_chapter3 = (
    (
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_o3_climuncert']['surface_temperature'] - results['remove_o3_climuncert']['surface_temperature'][0])
    ) +
    (
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_h2o_stratospheric_climuncert']['surface_temperature'] - results['remove_h2o_stratospheric_climuncert']['surface_temperature'][0])
    ...
    (
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_aerosol_climuncert']['surface_temperature'] - results['remove_aerosol_climuncert']['surface_temperature'][0])
    ) +
    (
        (results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0])-
        (results['remove_land_use_climuncert']['surface_temperature'] - results['remove_land_use_climuncert']['surface_temperature'][0])
...
AR6_forc['total'] = np.percentile(results['AR6-historical_climuncert']['surface_temperature'] - results['AR6-historical_climuncert']['surface_temperature'][0], (5,16,50,84,95), axis=1)
...
# %% cell 13
df_out.to_csv('../data_output/fig7.8.csv', index=False)
