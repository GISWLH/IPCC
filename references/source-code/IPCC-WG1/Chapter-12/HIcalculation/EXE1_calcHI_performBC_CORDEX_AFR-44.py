...
# Source: Chapter-12/HIcalculation/EXE1_calcHI_performBC_CORDEX_AFR-44.ipynb
...
all_models['rcp85'] = []
all_models['rcp26'] = []
with open(dir_names + 'Models_CORDEX-AFR-44_RCP26.txt', 'r') as filehandle:
    for line in filehandle:
        all_models['rcp26'].append(eval(line[:-1]))
with open(dir_names + 'Models_CORDEX-AFR-44_RCP85.txt', 'r') as filehandle:
    for line in filehandle:
