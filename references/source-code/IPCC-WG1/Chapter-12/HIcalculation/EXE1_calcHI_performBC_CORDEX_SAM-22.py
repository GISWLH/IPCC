...
# Source: Chapter-12/HIcalculation/EXE1_calcHI_performBC_CORDEX_SAM-22.ipynb
...
all_models['rcp85'] = []
all_models['rcp26'] = []
with open(dir_names + 'Models_CORDEX-SAM-22_RCP26.txt', 'r') as filehandle:
    for line in filehandle:
        all_models['rcp26'].append(eval(line[:-1]))
with open(dir_names + 'Models_CORDEX-SAM-22_RCP85.txt', 'r') as filehandle:
    for line in filehandle:
