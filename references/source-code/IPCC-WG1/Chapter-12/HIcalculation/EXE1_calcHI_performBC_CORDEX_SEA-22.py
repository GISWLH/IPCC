...
# Source: Chapter-12/HIcalculation/EXE1_calcHI_performBC_CORDEX_SEA-22.ipynb
...
all_models['rcp85'] = []
all_models['rcp26'] = []
with open(dir_names + 'Models_CORDEX-SEA-22_RCP26.txt', 'r') as filehandle:
    for line in filehandle:
        all_models['rcp26'].append(eval(line[:-1]))
with open(dir_names + 'Models_CORDEX-SEA-22_RCP85.txt', 'r') as filehandle:
    for line in filehandle:
...
for RCP in RCPs:
    ...
    for model in models:
        ...
        calendar = my_fun.concat_CORDEX(model, var_names_ORIG, RCP, dir_data, CORDEX_reg, time_orig, member, extract_version=False)
