...
# Source: Chapter-12/HIcalculation/EXE1_calcHI_performBC_CORDEX_CAM-22.ipynb
...
all_models['rcp85'] = []
all_models['rcp26'] = []
with open(dir_names + 'Models_CORDEX-CAM-22_RCP26.txt', 'r') as filehandle:
    for line in filehandle:
        all_models['rcp26'].append(eval(line[:-1]))
with open(dir_names + 'Models_CORDEX-CAM-22_RCP85.txt', 'r') as filehandle:
    for line in filehandle:
...
for RCP in RCPs:
    ...
    for model in models:
        ...
        #Select WFDE5 grid
        if model[1]=='ICTP-RegCM4-7':      regrid_name = CORDEX_reg + '_rlat-RegCM4'
        elif model[1]=='GERICS-REMO2015':  regrid_name = CORDEX_reg + '_rlat-REMO'
