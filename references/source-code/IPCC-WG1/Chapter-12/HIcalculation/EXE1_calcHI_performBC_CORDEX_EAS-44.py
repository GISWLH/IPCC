...
# Source: Chapter-12/HIcalculation/EXE1_calcHI_performBC_CORDEX_EAS-44.ipynb
...
all_models = dict()
all_models['rcp85'] = []
with open(dir_names + 'Models_CORDEX-EAS-44_RCP85.txt', 'r') as filehandle:
...
# %% cell 8
#Define model string
model = ['CNRM-CERFACS-CNRM-CM5', 'CLMcom-CCLM5-0-2', 'rlat-stand']
