...
# Source: Chapter-12/Figures/scripts/AFRICA_regional_figure/CoastalRecession_map_AR6regions_AFRICA.ipynb
...
def add_CR_data_points(wks, map, scenario, horizon, region_name, inc, colormap, reverse=False, method=1):
    ...
    json_filename = CWD+'/../../data/Figure_12.5/CoastalRecession_'+region_name+'_'+scenario+'_'+horizon+'.json'
...
trim_figure = CWD+'/../../figs/Figure_12.5/panel_b_AFRICA_'+variable+'_map_'+scenario+'_'+horizon+'.pdf'
...
variable = 'CoastalRecession'
trim_figure = CWD+'/../../figs/Figure_12.5/panel_b_AFRICA_'+variable+'_map_'+scenario+'_'+horizon+'.png'
# -- Trim the margins
