...
# Source: Chapter-12/Figures/scripts/HI_satellites/.ipynb_checkpoints/Quantile_plot_region-checkpoint.ipynb
...
# -- CMIP6
ensemble = 'CMIP6'
json_file = paste(CWD,'/../../data/Figure_S12.2/',ensemble,'_HI41_AR6_regional_averages.json',sep='')
...
#legend is the last
fsize = 2000
outfilename = paste(CWD,'/../../figs/Satellite_barplots/Figure_S12.2_HI_satellite.png',sep='')
...
# %% cell 19
fsize = 20*1.4
outfilename = paste(CWD,'/../../figs/Satellite_barplots/Figure_S12.2_HI41_satellite.pdf',sep='')
