...
# Source: Chapter-12/Figures/scripts/EUROPE_regional_figure/.ipynb_checkpoints/SWE_Quantile_plot_region-checkpoint.ipynb
...
ensemble = 'CMIP6'
json_file = paste(CWD,'/../../data/Figure_12.9/',ensemble,'_EUR-11_snw_',mask,'_AR6_regional_averages.json',sep='')
...
# %% cell 15
ensemble = 'CORDEX'
json_file = paste(CWD,'/../../data/Figure_12.9/EURO-',ensemble,'_SWE_mask14_AR6_regional_averages.json',sep='')
json_data <- fromJSON(paste(readLines(json_file), collapse=""))
...
figname = paste(CWD,'/../../figs/Figure_12.9/panel_d_',region,'_SWE_',mask,'_boxplot.png',sep='')
...
# %% cell 25
figname = paste(CWD,'/../../figs/Figure_12.9/panel_d_',region,'_SWE_',mask,'_boxplot.pdf',sep='')
