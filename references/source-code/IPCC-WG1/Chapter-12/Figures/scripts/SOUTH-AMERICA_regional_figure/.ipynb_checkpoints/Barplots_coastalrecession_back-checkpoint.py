...
# Source: Chapter-12/Figures/scripts/SOUTH-AMERICA_regional_figure/.ipynb_checkpoints/Barplots_coastalrecession_back-checkpoint.ipynb
...
"coastal_plot"=function(res, title, ylab='FALSE', mar=c(3,4,2,0), do_ylab='TRUE', do_xlab='TRUE'){
    ...
    if (do_xlab=='TRUE'){
        ...
        axis(1, at=c(2,4), tick='FALSE', labels=c('term','term'), font=1, line=1.6)
        par(cex=general_cex)
    }#end
...
subregions = c('SCA','NSA','NWS','NES','SWS','SSA','SES')
...
figname = paste('/home/jservon/Chapter12_IPCC/figs/Figure_12.8/',region,'_CoastalRecession_boxplot_RCP85_2100.png',sep='')
...
layout(mat, heights=c(1,1,1.25,0.7), widths=c(1.25,1,1))
i = 1
