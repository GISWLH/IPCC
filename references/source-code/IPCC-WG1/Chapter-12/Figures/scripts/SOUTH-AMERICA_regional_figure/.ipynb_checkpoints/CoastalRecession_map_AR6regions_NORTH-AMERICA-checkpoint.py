...
# Source: Chapter-12/Figures/scripts/SOUTH-AMERICA_regional_figure/.ipynb_checkpoints/CoastalRecession_map_AR6regions_NORTH-AMERICA-checkpoint.ipynb
...
test = []
for elt in misc_div_21_raw:
    tmp = []
    for eelt in elt:
        tmp.append(eelt/256.)
    tmp.append(1.)
    test.append(tmp)
misc_div_21 = numpy.array(test)
...
# Draw a text string labeling the marker
Ngl.text_ndc(wks,"Coastal recession by "+horizon,0.5,0.86,txres)
Ngl.text_ndc(wks,"CMIP5 "+scenario,0.5,0.83,txres)
Ngl.text_ndc(wks,"(b)",0.22,0.83,txres)
...
trim_figure = '/home/jservon/Chapter12_IPCC/figs/AFRICA_regional_figure/AFRICA_'+variable+'_map_'+scenario+'_'+horizon+'.png'
