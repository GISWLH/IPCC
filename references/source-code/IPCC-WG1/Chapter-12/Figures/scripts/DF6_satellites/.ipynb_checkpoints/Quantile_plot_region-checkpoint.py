...
# Source: Chapter-12/Figures/scripts/DF6_satellites/.ipynb_checkpoints/Quantile_plot_region-checkpoint.ipynb
...
# -- CMIP6
ensemble = 'CMIP6'
json_file = paste(CWD,'/../../data/Figure_S12.3/',ensemble,'_DF6_AR6_regional_averages.json',sep='')
...
for (clim_period in names(json_data)){
    if (clim_period=='ssp585_hist'){ wclim_period='modern' }
    if (clim_period=='ssp585_midfut'){ wclim_period='8.5_mid' }
    if (clim_period=='ssp585_farfut'){ wclim_period='8.5_late' }
    if (clim_period=='ssp126_midfut'){ wclim_period='2.6_mid' }
    if (clim_period=='ssp126_farfut'){ wclim_period='2.6_late' }
    if (clim_period=='GWL1.5'){ wclim_period='1.5' }
    if (clim_period=='GWL2.0'){ wclim_period='2' }
    if (clim_period=='GWL3.0'){ wclim_period='3' }
    if (clim_period=='GWL4.0'){ wclim_period='4' }
    print(wclim_period)
...
for (clim_period in names(json_data)){
    if (clim_period=='rcp85_hist'){ wclim_period='modern' }
    if (clim_period=='rcp85_midfut'){ wclim_period='8.5_mid' }
    if (clim_period=='rcp85_farfut'){ wclim_period='8.5_late' }
    if (clim_period=='rcp26_midfut'){ wclim_period='2.6_mid' }
    if (clim_period=='rcp26_farfut'){ wclim_period='2.6_late' }
    if (clim_period=='GWL1.5'){ wclim_period='1.5' }
    if (clim_period=='GWL2.0'){ wclim_period='2' }
    if (clim_period=='GWL3.0'){ wclim_period='3' }
    if (clim_period=='GWL4.0'){ wclim_period='4' }
...
#legend is the last
fsize = 2000
outfilename = paste(CWD,'/../../figs/Satellite_barplots/Figure_S12.3_DF6_satellite.png',sep='')
...
# %% cell 19
fsize = 20*1.4
outfilename = paste(CWD,'/../../figs/Satellite_barplots/Figure_S12.3_DF6_satellite.pdf',sep='')
