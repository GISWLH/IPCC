...
# Source: Chapter-12/Figures/scripts/ASIA_regional_figure/.ipynb_checkpoints/Barplots_coastalrecession-checkpoint.ipynb
...
subregions = c('WCA','EAS','RFE','ARP','SAS','SEA')
...
figname = paste(CWD,'/../../figs/Figure_12.6/panel_d_',region,'_CoastalRecession_boxplot_RCP85_2100.png',sep='')
...
# %% cell 7
figname = paste(CWD,'/../../figs/Figure_12.6/panel_d_',region,'_CoastalRecession_boxplot_RCP85_2100.pdf',sep='')
